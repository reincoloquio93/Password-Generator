...
// Starting Code - arrays for the password//
...
function generatePassword() {
    var passLength = parseInt(prompt("Please enter your ideal length password minimum of 8 characters and no more than 128 characters"));
